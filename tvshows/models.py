...
class Tvshow(models.Model):
    ...
    poster = models.ImageField(upload_to='photos/posters/tvshows' )
    ...
    tags = models.ManyToManyField(Tag() , blank=True  , related_name="tvshows_tags")
...
class Comment(models.Model):
    ...
    user_nam = models.ForeignKey(User , on_delete=models.CASCADE , related_name="tvshow_comment")
    tvshow_name = models.ForeignKey(Tvshow , on_delete=models.CASCADE)
